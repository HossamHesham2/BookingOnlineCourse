            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <!-- Page Heading -->
                        <h1 class="h3 mb-2 text-gray-800">Students ID : <?= $row['id'] ?></h1>
                        <div class="row">
                            <div class="col-4 m-auto">
                                <div class="card  text-center">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <a href="/fullstackProject/dashboard/admin/students/viewStudents.php" class="btn btn-primary">Back</a>
                                        <a href="/fullstackProject/dashboard/admin/students/editStudent.php?id=<?= $row['id'] ?>" class="btn btn-warning">Edit</a>
                                    </div>
                                </div>
                            </div>
                        </div>
