...
if (isset($_SESSION["role"]) && $_SESSION["role"] === "admin") {
    ...
    if (isset($_POST['submit'])) {
        ...
        if (empty($errors)) {
            ...
            $sql = "INSERT INTO users (name, email, phone, password, image , role) VALUES ('$name', '$email', '$phone', '$password_hashed', '$URL' , '$role')";
            ...
            <div id="content-wrapper" class="d-flex flex-column">
                <div id="content">
                    ...
                    <div class="container-fluid">
                        <h2 class="section-title">Add New Instructor</h2>
                        <div class="row">
                            <div class="col-12 col-md-6 col-lg-12">
                                <div class="card">
                                    <form class="needs-validation" autocomplete="off" novalidate action="addInstructor.php" enctype="multipart/form-data" method="post">
